...
package automat;
/**
 * Model af en simpel billetautomat til enkeltbilletter med Ã©n fast pris.
 */
public class Billetautomat {
	private int billetpris;    // Prisen for Ã©n billet.
	...
	/**
	 * Giver balancen (belÃ¸bet maskinen har modtaget til den nÃ¦ste billet).
	 */
	...
	public void montørLogin(String adgangskode) {
		if ("1234".equals(adgangskode)) {
			montørtilstand = true;
			System.out.println("MontÃ¸rtilstand aktiveret");
			System.out.println("Du kan nu angive billetpris");
		} else {
			montørtilstand = false;
			System.out.println("MontÃ¸rtilstand deaktiveret");
		}
	}
	...
	public int getTotal() {
		if (montørtilstand) {
			...
			System.out.println("Afvist - log ind fÃ¸rst");
			return 0;
		}
	}
